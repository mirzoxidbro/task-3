                        ...
                        <div class='mt-10'>  
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="flex">
                                    @if($application->file_url !== null)
                                            <div class="border m-6 p-6 rounded hover:bg-gray-200 cursor-pointer">
                            ...
                            @if (! $application->answer()->exists())
                                <div class="flex justify-end">
                                    <a href="{{ route('answers.create', ['application' => $application->id])  }}" class="bg-green-500 text-white px-6 py-2 rounded font-medium mx-3 hover:bg-green-600 transition duration-200 each-in-out">Answer</a>
                                </div>
                            @else
                            <div class="">
                                <hr>
                                <h1 class="font-bold mt-2 text-indigo-600">Answer: </h1>
