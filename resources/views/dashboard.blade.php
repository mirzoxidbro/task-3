                    ...
                    @if (auth()->user()->role->name == 'manager')
                        ...
                        <div class='mt-5'>  
                            ...
                            <div class="flex items-center space-x-8">
                                <button class="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs font-semibold">id: 8</button>
                                    ...
                                    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                                        <div class='max-w-md mx-auto space-y-6'>
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <textarea rows="5" name="subject" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none"></textarea>
